...
if (!function_exists('get_option')) {
     ...
     * @return mixed
     */
    function get_option($key, bool $decode = false, bool $locale = false, $associative = false): mixed
    {
        if ($locale == true) {
           $cacheKey = $key.current_locale();
        }
        else{
            $cacheKey = $key;
        }
...
if (!function_exists('current_locale')) {
    ...
    {
    	return Session::get('locale', env('DEFAULT_LANG','en'));;
    }
}
