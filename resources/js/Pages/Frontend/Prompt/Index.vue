...
const filterPrompt = () => {
  router.get(route("prompt.index"), pickBy(filterForm.value), {
    preserveState: true,
    replace: true
  })
}
      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="breadcrumb__content text-center">
            <h3 class="breadcrumb__title">{{ trans("Prompt") }}</h3>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xxl-9 col-xl-9 col-lg-8 order-first order-lg-last">
            <div
              class="shop__filter-top-right d-md-flex align-items-center"
              :class="
                searchQuery ? 'justify-content-between' : 'justify-content-end'
              "
            >
              <div class="breadcrumb__list" v-if="searchQuery">
                <span> {{ trans("Looking For") }} "{{ searchQuery }}"</span>
              </div>
