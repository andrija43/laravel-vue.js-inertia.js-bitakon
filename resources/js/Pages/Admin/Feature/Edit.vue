<template>
  ...
  <div class="container-fluid mt--6">
    ...
    >
      <div class="row">
        <div class="col-lg-5">
          <strong>{{ trans("Edit a step") }}</strong>
          <p>
            {{
              trans(
                "Add step details and necessary information from here"
              )
            }}
          </p>
        </div>
...
const update = () => {
  router.post(
    route("admin.features.update", props.info.id),
    {
      _method: "PATCH",
      data: form
    },
    {
      onSuccess: () => {
        ToastAlert("Congratulations", "Settings Successfully")
      }
    }
  )
}
